...
const val ONLINE_PLAYLIST_DETAIL_ROUTE =
    "$ONLINE_PLAYLIST_DETAIL_ROUTE_BASE?$ONLINE_PLAYLIST_ID_ARG={$ONLINE_PLAYLIST_ID_ARG}&$IS_ALBUM_ARG={$IS_ALBUM_ARG}"

fun NavController.navigateToOnlinePlaylistDetail(
