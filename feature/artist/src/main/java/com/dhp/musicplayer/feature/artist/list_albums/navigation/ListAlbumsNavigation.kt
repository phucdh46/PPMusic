...
const val LIST_ALBUMS_ROUTE =
    "$LIST_ALBUMS_ROUTE_BASE?$LIST_ALBUMS_BROWSE_ID_ARG={$LIST_ALBUMS_BROWSE_ID_ARG}&$LIST_ALBUMS_PARAMS_ARG={$LIST_ALBUMS_PARAMS_ARG}"

fun NavController.navigateToListAlbums(
