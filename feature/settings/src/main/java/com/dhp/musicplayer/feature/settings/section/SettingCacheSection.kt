...
//    }
    ...
    Column(modifier) {
        ...
        SettingCacheItem(
            ...
            description = stringResource(R.string.setting_cache_size_used_text, formatFileSize(downloadCacheSize)),
...
//                    }
        ...
        SettingCacheItem(
            ...
            description = if (maxSongCacheSize != -1) {
                stringResource(
                    R.string.setting_cache_size_used_text,
                ...
                stringResource(R.string.setting_cache_size_used_text, formatFileSize(playerCacheSize)),
            selectedValue = maxSongCacheSize,
            values = listOf(128, 256, 512, 1024, 2048, 4096, 8192, -1),
            valueText = {
                if (it == -1) stringResource(R.string.setting_cache_unlimited_option) else formatFileSize(it * 1024 * 1024L)
            },
        ...
        Coil.imageLoader(context).diskCache?.let { diskCache ->
            ...
            SettingCacheItem(
                ...
                description = stringResource(R.string.setting_cache_size_used_text, "${formatFileSize(diskCacheSize)} / ${formatFileSize(maxImageCacheSize.toLong()  * 1024 * 1024L)}") +
