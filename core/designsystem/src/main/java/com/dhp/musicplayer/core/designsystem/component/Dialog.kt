...
fun TextFieldDialog(
    ...
    onDismiss: () -> Unit,
    onDone: (String) -> Unit,
    cancelText: String = stringResource(R.string.cancel_button_dialog),
    doneText: String = stringResource(R.string.done_button_dialog),
...
fun ConfirmationDialog(
    ...
    modifier: Modifier = Modifier,
    cancelText: String = stringResource(R.string.cancel_button_dialog),
    confirmText: String = stringResource(R.string.confirm_button_dialog),
    onCancel: () -> Unit = onDismiss,
    title: (@Composable () -> Unit)? = null,
    icon: (@Composable () -> Unit)? = null,
